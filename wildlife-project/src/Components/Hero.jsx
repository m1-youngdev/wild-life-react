...
function Hero() {
  return (
    <div>
      <div className="hero z-30 bg-[url('https://res.cloudinary.com/dwmgepoeg/image/upload/v1764934213/photo-1545063914-a1a6ec821c88_pwmao5.jpg')] bg-cover bg-center h-screen w-screen">
       <div className="opacity-div z-30 w-screen h-screen bg-[#242A26] bg-opacity-40 ">
